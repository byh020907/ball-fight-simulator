...
| 속도 해방 1단계 | bronze | 2배속 관전 전환 해금 (관전 전투 화면 터치) |
| 대역전 | silver | 빌드 유연성 +5 |
| 반격 전문가 | silver | 빌드 유연성 +5 |
| 연승 | silver | 추가 배분 포인트 +10 |
| 속도 해방 2단계 | silver | 4배속 관전 전환 해금 (관전 전투 화면 터치) |
| 무결점 우승 | gold | 집중 투자 한도 +15 |
| 전캐릭터 우승 | gold | 집중 투자 한도 +15 |
| 도감 완성 | gold | 집중 투자 한도 +20 |
| 단일 대미지 150 | gold | 추가 배분 포인트 +15 |

**총 누적**: 추가 배분 포인트 +55 (상한 40 ← 초과분은 자동 클램프), 빌드 유연성 +10 (상한 10), 집중 투자 한도 +50 (상한 50)
...
11. 캐릭터 연계 프로필과 통합
12. `docs/game-rules.md`, `src/helpContent.js`, `src/patchNotes.js` 갱신
