...
- Grenade Ball은 상대 방향으로 2~4개의 수류탄을 산탄처럼 발사합니다(쿨타임 4.0초). 각 수류탄은 벽에 최대 2회 튕기며 0.8초 후 폭발합니다. 폭발 데미지는 중심 40에서 가장자리 20까지 거리 비례 감소하며, 근처 적을 넉백시킵니다. 센서 신관(140px)이 있어 적 근접 시 0.2초 후 자동 폭발합니다. 예측 조준/미스 스트릭/패시브 회피는 제거되었습니다.
