...
- Grenade Ball의 수류탄은 벽에 최대 2회 튕깁니다. 폭발 데미지는 중심 40에서 가장자리 20까지 거리 비례 감소. 빗나갈수록 퓨즈가 짧아져 더 빨리 터집니다. 쿨타임은 기본값 4.7초 기준 ±50% 범위에서 랜덤하게 결정됩니다. (0.5~1.5배). 또한 수류탄이 적 반경 180px 이내에 들어오면 0.2초 후 자동 폭발하는 센서 신관이 내장되어 있습니다.
