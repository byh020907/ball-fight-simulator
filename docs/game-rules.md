...
- Grenade Ball은 상대 방향 120° 범위에서 2~4개의 수류탄을 순차 발사합니다(쿨타임 4.5초, 발사 간격 0.12초). 각 수류탄은 첫발 퓨즈 0.6초에서 마지막발 2.0초로 선형 지연 폭발하며, 벽에 최대 4회 튕깁니다. 폭발 데미지는 중심 20에서 가장자리 10까지 거리 비례 감소. 넉백이 크게(600px/s, 0.5초) 밀려 연쇄 폭발을 유도합니다. 센서 신관/예측 조준/미스 스트릭/패시브 회피 제거.
