...
- Grenade Ball은 상대 방향 90° 범위에서 2~4개의 수류탄을 순차 발사합니다(쿨타임 3.5초, 발사 간격 0.12초). 모든 수류탄은 1000px/s로 날아가며, 첫발 퓨즈 0.3초에서 마지막발 0.8초로 선형 지연 폭발합니다. 벽에 최대 4회 튕깁니다. 폭발 데미지는 중심 30에서 가장자리 15까지 거리 비례 감소. 넉백(600px/s, 0.5초)으로 연쇄 폭발을 유도합니다. 센서 신관/예측 조준/미스 스트릭/패시브 회피 제거.
